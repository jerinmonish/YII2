...
<div id="navbar-container" class="boxed">
                ...
                <div class="navbar-header">
                    <a href="<?php echo Yii::$app->urlManager->createUrl('site/') ?>" class="navbar-brand">
                        <img src="<?php echo $this->theme->baseUrl; ?>/assets/img/logo.png" alt="Nifty Logo" class="brand-icon">
                        <div class="brand-title">
                            <span class="brand-text"><?php echo Yii::$app->params['title']; ?></span>
                        </div>
                    </a>
                </div>
                <!--================================-->
                                    ...
                                    <div class="nano-content">
                                        <ul class="head-list">
									        ...
									        <li>
									            <a href="#" class="media">
									                <div class="media-left">
									                    <img src="<?php echo $this->theme->baseUrl; ?>/assets/img/av4.png" alt="Profile Picture" class="img-circle img-sm">
									                </div>
									        ...
									        <li>
									            <a href="#" class="media">
									                <div class="media-left">
									                    <img src="<?php echo $this->theme->baseUrl; ?>/assets/img/av3.png" alt="Profile Picture" class="img-circle img-sm">
									                </div>
									                <div class="media-body">
                        ...
                        <li id="dropdown-user" class="dropdown">
                            <a href="#" data-toggle="dropdown" class="dropdown-toggle text-right">
                                <span class="pull-right">
                                    <img class="img-circle img-user media-object" src="<?php echo $this->theme->baseUrl; ?>/assets/img/av1.png" alt="Profile Picture">
                                </span>
                            ...
                            <div class="dropdown-menu dropdown-menu-md dropdown-menu-right panel-default">
                                ...
                                <div class="pad-all text-right">
                                    <a href="<?php echo Yii::$app->urlManager->createUrl(['site/logout']); ?>" class="btn btn-primary">
