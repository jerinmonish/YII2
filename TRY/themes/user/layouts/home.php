...
<body class="home-page">
    <div class="wrapper">
        ...
        <div class="content container">
            ...
            <!--//flexslider-->
            <!--news-->
                <?= frontend\widgets\LatestNews::widget() ?>
            <!--//news-->
            <div class="row cols-wrapper">
                <!--Events start -->
                    <?= frontend\widgets\Events::widget() ?>
                <!--//Events col-md-3-->
                <!--Course Finder -->
                    <?= frontend\widgets\CourseFinder::widget() ?>
                    <?= frontend\widgets\VideoTour::widget() ?>
                <!--Course Finder-->
                <div class="col-md-3">
                    <!--Quick Links -->
                        <?= frontend\widgets\QuickLinks::widget() ?>
                    <!--//Quick links-->
            ...
            <!--Clients slider-->
                <?= frontend\widgets\SliderTwo::widget() ?>
            <!--Clients slider -->
        </div><!--//content-->
    </div><!--//wrapper-->
