                                ...
                                <div class="carousel-inner">
                                    <div class="item active">
                                        ...
                                        <div class="row">
                                            ...
                                            <img class="profile col-md-4 pull-right" src="<?php echo $this->theme->baseUrl; ?>/assets/images/testimonials/profile-1.png"  alt="" />
                                        </div>                               
                                    </div><!--//item-->
                                    <div class="item">
                                        <blockquote class="quote">
                                        ...
                                        <div class="row">
                                            ...
                                            <img class="profile col-md-4 pull-right" src="<?php echo $this->theme->baseUrl; ?>/assets/images/testimonials/profile-2.png"  alt="" />
                                        </div>                 
                                    </div><!--//item-->
                                    <div class="item">
                                        <blockquote class="quote">
                                        ...
                                        <div class="row">
                                            ...
                                            <img class="profile col-md-4 pull-right" src="<?php echo $this->theme->baseUrl; ?>/assets/images/testimonials/profile-3.png"  alt="" />
                                        </div>                 
                                    </div><!--//item-->
