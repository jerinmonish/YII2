...
<div id="promo-slider" class="slider flexslider">
                <ul class="slides">
                    <li>
                        <img src="<?php echo $this->theme->baseUrl; ?>/assets/images/slides/slide-1.jpg"  alt="" />
                    ...
                    <li>
                        <img src="<?php echo $this->theme->baseUrl; ?>/assets/images/slides/slide-2.jpg"  alt="" />
                        <p class="flex-caption">
                    ...
                    <li>
                        <img src="<?php echo $this->theme->baseUrl; ?>/assets/images/slides/slide-3.jpg"  alt="" />
                        <p class="flex-caption">
                    ...
                    <li>
                        <img src="<?php echo $this->theme->baseUrl; ?>/assets/images/slides/slide-4.jpg"  alt="" />
                        <p class="flex-caption">
